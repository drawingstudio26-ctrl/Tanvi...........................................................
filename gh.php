    ...
    <div class="row">
      <div class="col-md-4 mb-4">
        <div class="product-card">
          <img src="Img/bananas.jpg" alt="Organic Bananas" class="gallery-img" onclick="viewImage('Img/bananas.jpg')>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-6">
            <div class="about-card h-100">
              ...
              <!-- Paste the zoom modal code here -->
<div id="productZoomModal" class="product-zoom-modal">
  <div class="zoom-content">
    <span class="close-zoom">&times;</span>
    <div class="row">
      <div class="col-md-6">
        <img id="zoomedImg" style="width:100%;max-height:400px;object-fit:contain;">
      </div>
      <div class="col-md-6">
        <h3 id="zoomedTitle"></h3>
        <p id="zoomedDesc"></p>
        <div class="price-tag" id="zoomedPrice"></div>
        <button class="btn btn-success" id="zoomAddToCartBtn">Add to Cart</button>
      </div>
    </div>
  </div>
</div>
  ...
  function setupProductZoom() {
    ...
    productCards.forEach(card => {
      card.addEventListener('click', function(e) {
        // Don't zoom if clicking on the Add to Cart button
        ...
        const addToCartBtn = this.querySelector('.btn-success');
        
        // Set modal content
        document.getElementById('zoomedProductImage').src = productImage;
        document.getElementById('zoomedProductName').textContent = productName;
        document.getElementById('zoomedProductDescription').textContent = productDescription;
        document.getElementById('zoomedProductPrice').textContent = productPrice;
        
        // Copy the original Add to Cart functionality
        document.getElementById('zoomedAddToCart').onclick = function() {
          addToCartBtn.click();
        };
        
        // Show modal
        document.getElementById('productZoomModal').style.display = 'block';
      });
    });
    
    // Close modal when clicking X
    document.querySelector('.close-zoom').addEventListener('click', function() {
      document.getElementById('productZoomModal').style.display = 'none';
    });
    
    // Close modal when clicking outside
    window.addEventListener('click', function(event) {
      if (event.target == document.getElementById('productZoomModal')) {
        document.getElementById('productZoomModal').style.display = 'none';
      }
    });
  }
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelectorAll('.product-card').forEach(card => {
    card.addEventListener('click', function(e) {
      // Don't zoom if clicking on buttons/badges
      if(e.target.tagName === 'BUTTON' || e.target.closest('.badge')) return;
      ...
      const addBtn = this.querySelector('.btn-success');
      
      // Display in modal
      document.getElementById('zoomedImg').src = img;
      document.getElementById('zoomedTitle').textContent = title;
      document.getElementById('zoomedDesc').textContent = desc;
      document.getElementById('zoomedPrice').textContent = price;
      
      // Make Add to Cart work
      document.getElementById('zoomAddToCartBtn').onclick = function() {
        addBtn.click();
      };
...
function closeImage() {
  ...
  window.onclick = function(e) {
    if(e.target == document.getElementById('productZoomModal')) {
      document.getElementById('productZoomModal').style.display = 'none';
    }
  };
});
  // Initialize on page load
  document.addEventListener('DOMContentLoaded', setupProductZoom);
...
<!-- Image Zoom Modal -->
<div id="imageModal" class="modal" style="display:none; position:fixed; z-index:9999; left:0; top:0; width:100%; height:100%; background:rgba(0,0,0,0.8); justify-content:center; align-items:center;">
    <span style="position:absolute; top:20px; right:30px; color:white; font-size:30px; cursor:pointer;" onclick="closeImage()">&times;</span>
    <img id="modalImg" src="" style="max-width:90%; max-height:90%; border:5px solid white; border-radius:10px;">
</div>
