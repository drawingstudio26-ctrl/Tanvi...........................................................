...
/* For mobile screens (Android, iPhone, etc.) */
@media (max-width: 576px) {
  .hero-banner {
    padding: 30px 15px;   /* less space around banner */
    text-align: center;   /* keep things centered */
  }
      ...
      <div class="modal-body px-4 pb-4">
        ...
        <div class="tab-content" id="enquiryTabContent">
          ...
          <div class="tab-pane fade show active" id="new-tab-pane" role="tabpanel" tabindex="0">
            <form id="enquiryForm" method="POST" action="save_enquiry.php">
  <div class="mb-3">
    <label for="enquiryName" class="form-label text-dark">Full Name</label>
    <input type="text" class="form-control border-1 border-secondary rounded-1" id="enquiryName" name="enquiryName" required>
  </div>

  <div class="row">
    <div class="col-md-6 mb-3">
      <label for="enquiryEmail" class="form-label text-dark">Email Address</label>
      <input type="email" class="form-control border-1 border-secondary rounded-1" id="enquiryEmail" name="enquiryEmail" required>
    </div>
    <div class="col-md-6 mb-3">
      <label for="enquiryPhone" class="form-label text-dark">Phone Number</label>
      <input type="tel" class="form-control border-1 border-secondary rounded-1" id="enquiryPhone" name="enquiryPhone">
    </div>
  </div>

  <div class="mb-3">
    <label for="enquirySubject" class="form-label text-dark">Subject</label>
    <input type="text" class="form-control border-1 border-secondary rounded-1" id="enquirySubject" name="enquirySubject" required>
  </div>

  <div class="mb-3">
    <label for="enquiryMsg" class="form-label text-dark">Your Message</label>
    <textarea class="form-control border-1 border-secondary rounded-1" id="enquiryMsg" name="enquiryMsg" rows="4" required></textarea>
  </div>
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        if (response.trim() === 'success') {
          ...
          setTimeout(function() {
            window.location.href = 'index.php'; // Change to your home page if different
          }, 1000);
        } else {
